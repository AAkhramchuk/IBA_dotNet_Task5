...
namespace Task5MovieApp.Controllers
{
    public class GenresController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Genre != null ?
                View(await _context.Genre.ToListAsync()) :
                    Problem("Entity set 'MovieAppContext.Genre'  is null.");
        }
        ...
        public async Task<IActionResult> Create()
        {
            ...
            //ViewBag.Genre = genre;
            //@Html.DropDownListFor(model => model.Id, ViewBag.Genre as SelectList)
            return View();
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GenreContext.Genre'  is null.");
            }
            var genre = await _context.Genre.FindAsync(id);
            if (genre != null)
            {
